...
impl Display for Property {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Property::TextWrap(value) => write!(f, "text-wrap:{value};"),
...
impl Property {
    ...
    fn deferred(&self) -> Option<(&Arc<str>, SourceLocation)> {
        ...
        match self {
            ...
            Property::TextWrap(Deferred(s, loc)) => Some((s, *loc)),
    ...
    fn reparse_value<'i>(&self, value: &'i str) -> Result<Props, cssparser::ParseError<'i, CustomParseError>> {
        ...
        match self {
            ...
            Property::TextWrap(_) => parse_property(&mut parser, parse_text_wrap, Property::TextWrap),
    ...
    fn apply_resolved(&self, style: &mut Style, parent_style: Option<&Style>) {
        ...
        match self {
            ...
            Property::TextWrap(v) => apply_value(v, &mut style.text_wrap, parent_style, &def, |s| &s.text_wrap),
